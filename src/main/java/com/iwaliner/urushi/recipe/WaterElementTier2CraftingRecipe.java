...
public class WaterElementTier2CraftingRecipe extends AbstractElementCraftingRecipe{
    ...
    public static class WaterElementTier2CraftingSerializer implements RecipeSerializer<WaterElementTier2CraftingRecipe> {
        public static final MapCodec<WaterElementTier2CraftingRecipe> CODEC = RecordCodecBuilder.mapCodec(inst -> inst.group(
                ...
                return new WaterElementTier2CraftingRecipe(__list, out, ResourceLocation.fromNamespaceAndPath(ModCoreUrushi.ModID, "water_element_tier2_crafting"), i);
        }));

        public static final StreamCodec<RegistryFriendlyByteBuf, WaterElementTier2CraftingRecipe> STREAM_CODEC = StreamCodec.of(
                (buf, r) -> {
                ...
                (buf) -> {
                        ...
                        return new WaterElementTier2CraftingRecipe(__list, __out, ResourceLocation.fromNamespaceAndPath(ModCoreUrushi.ModID, "water_element_tier2_crafting"), __i);
                }
        );

        @Override
        public MapCodec<WaterElementTier2CraftingRecipe> codec() { return CODEC; }

        @Override
        public StreamCodec<RegistryFriendlyByteBuf, WaterElementTier2CraftingRecipe> streamCodec() { return STREAM_CODEC; }
