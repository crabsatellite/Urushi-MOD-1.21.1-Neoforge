...
public class FoxEatingRecipe implements Recipe<RecipeInput> {
    ...
    public static class FoxEatingSerializer implements RecipeSerializer<FoxEatingRecipe> {
        public static final MapCodec<FoxEatingRecipe> CODEC = RecordCodecBuilder.mapCodec(inst -> inst.group(
                ...
                return new FoxEatingRecipe(__list, out, ResourceLocation.fromNamespaceAndPath(ModCoreUrushi.ModID, "fox_eating"));
        }));

        public static final StreamCodec<RegistryFriendlyByteBuf, FoxEatingRecipe> STREAM_CODEC = StreamCodec.of(
                (buf, r) -> {
                ...
                (buf) -> {
                        ...
                        return new FoxEatingRecipe(__list, __out, ResourceLocation.fromNamespaceAndPath(ModCoreUrushi.ModID, "fox_eating"));
                }
        );

        @Override
        public MapCodec<FoxEatingRecipe> codec() { return CODEC; }

        @Override
        public StreamCodec<RegistryFriendlyByteBuf, FoxEatingRecipe> streamCodec() { return STREAM_CODEC; }
