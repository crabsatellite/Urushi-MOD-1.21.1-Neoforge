...
public class KettleRecipe implements Recipe<RecipeInput> {

    protected  NonNullList<Ingredient> ingredient;
    private final ItemStack result;
    private final ResourceLocation location;
    public static ResourceLocation locationType=ResourceLocation.fromNamespaceAndPath(ModCoreUrushi.ModID, "kettle");
    ...
    public static class KettleSerializer implements RecipeSerializer<KettleRecipe> {
        public static final MapCodec<KettleRecipe> CODEC = RecordCodecBuilder.mapCodec(inst -> inst.group(
                ...
                return new KettleRecipe(__list, out, ResourceLocation.fromNamespaceAndPath(ModCoreUrushi.ModID, "kettle"));
        }));

        public static final StreamCodec<RegistryFriendlyByteBuf, KettleRecipe> STREAM_CODEC = StreamCodec.of(
                (buf, r) -> {
                ...
                (buf) -> {
                        ...
                        return new KettleRecipe(__list, __out, ResourceLocation.fromNamespaceAndPath(ModCoreUrushi.ModID, "kettle"));
                }
        );

        @Override
        public MapCodec<KettleRecipe> codec() { return CODEC; }

        @Override
        public StreamCodec<RegistryFriendlyByteBuf, KettleRecipe> streamCodec() { return STREAM_CODEC; }
