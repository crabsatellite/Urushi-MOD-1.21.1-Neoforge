...
public class HammeringRecipe implements Recipe<RecipeInput> {
    ...
    public static class HammeringSerializer implements RecipeSerializer<HammeringRecipe> {
        public static final MapCodec<HammeringRecipe> CODEC = RecordCodecBuilder.mapCodec(inst -> inst.group(
                ...
                return new HammeringRecipe(__list, out, ResourceLocation.fromNamespaceAndPath(ModCoreUrushi.ModID, "frying"));
        }));

        public static final StreamCodec<RegistryFriendlyByteBuf, HammeringRecipe> STREAM_CODEC = StreamCodec.of(
                (buf, r) -> {
                ...
                (buf) -> {
                        ...
                        return new HammeringRecipe(__list, __out, ResourceLocation.fromNamespaceAndPath(ModCoreUrushi.ModID, "frying"));
                }
        );

        @Override
        public MapCodec<HammeringRecipe> codec() { return CODEC; }

        @Override
        public StreamCodec<RegistryFriendlyByteBuf, HammeringRecipe> streamCodec() { return STREAM_CODEC; }
