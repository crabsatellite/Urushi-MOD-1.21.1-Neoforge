...
public class FireElementTier2CraftingRecipe extends AbstractElementCraftingRecipe{
    ...
    public static class FireElementTier2CraftingSerializer implements RecipeSerializer<FireElementTier2CraftingRecipe> {
        public static final MapCodec<FireElementTier2CraftingRecipe> CODEC = RecordCodecBuilder.mapCodec(inst -> inst.group(
                ...
                return new FireElementTier2CraftingRecipe(__list, out, ResourceLocation.fromNamespaceAndPath(ModCoreUrushi.ModID, "fire_element_tier2_crafting"), i);
        }));

        public static final StreamCodec<RegistryFriendlyByteBuf, FireElementTier2CraftingRecipe> STREAM_CODEC = StreamCodec.of(
                (buf, r) -> {
                ...
                (buf) -> {
                        ...
                        return new FireElementTier2CraftingRecipe(__list, __out, ResourceLocation.fromNamespaceAndPath(ModCoreUrushi.ModID, "fire_element_tier2_crafting"), __i);
                }
        );

        @Override
        public MapCodec<FireElementTier2CraftingRecipe> codec() { return CODEC; }

        @Override
        public StreamCodec<RegistryFriendlyByteBuf, FireElementTier2CraftingRecipe> streamCodec() { return STREAM_CODEC; }
