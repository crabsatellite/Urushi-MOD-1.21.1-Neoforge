...
public class RainwaterTankRecipe implements Recipe<RecipeInput> {
    ...
    public static class RainwaterTankSerializer implements RecipeSerializer<RainwaterTankRecipe> {
        public static final MapCodec<RainwaterTankRecipe> CODEC = RecordCodecBuilder.mapCodec(inst -> inst.group(
                ...
                return new RainwaterTankRecipe(__list, out, ResourceLocation.fromNamespaceAndPath(ModCoreUrushi.ModID, "frying"));
        }));

        public static final StreamCodec<RegistryFriendlyByteBuf, RainwaterTankRecipe> STREAM_CODEC = StreamCodec.of(
                (buf, r) -> {
                ...
                (buf) -> {
                        ...
                        return new RainwaterTankRecipe(__list, __out, ResourceLocation.fromNamespaceAndPath(ModCoreUrushi.ModID, "frying"));
                }
        );

        @Override
        public MapCodec<RainwaterTankRecipe> codec() { return CODEC; }

        @Override
        public StreamCodec<RegistryFriendlyByteBuf, RainwaterTankRecipe> streamCodec() { return STREAM_CODEC; }
