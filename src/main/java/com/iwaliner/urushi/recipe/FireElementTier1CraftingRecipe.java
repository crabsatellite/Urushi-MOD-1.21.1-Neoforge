...
public class FireElementTier1CraftingRecipe extends AbstractElementCraftingRecipe{
    ...
    public static class FireElementTier1CraftingSerializer implements RecipeSerializer<FireElementTier1CraftingRecipe> {
        public static final MapCodec<FireElementTier1CraftingRecipe> CODEC = RecordCodecBuilder.mapCodec(inst -> inst.group(
                ...
                return new FireElementTier1CraftingRecipe(__list, out, ResourceLocation.fromNamespaceAndPath(ModCoreUrushi.ModID, "fire_element_tier1_crafting"), i);
        }));

        public static final StreamCodec<RegistryFriendlyByteBuf, FireElementTier1CraftingRecipe> STREAM_CODEC = StreamCodec.of(
                (buf, r) -> {
                ...
                (buf) -> {
                        ...
                        return new FireElementTier1CraftingRecipe(__list, __out, ResourceLocation.fromNamespaceAndPath(ModCoreUrushi.ModID, "fire_element_tier1_crafting"), __i);
                }
        );

        @Override
        public MapCodec<FireElementTier1CraftingRecipe> codec() { return CODEC; }

        @Override
        public StreamCodec<RegistryFriendlyByteBuf, FireElementTier1CraftingRecipe> streamCodec() { return STREAM_CODEC; }
