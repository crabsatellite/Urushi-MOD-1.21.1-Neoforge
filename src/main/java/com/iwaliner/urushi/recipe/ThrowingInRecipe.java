...
public class ThrowingInRecipe implements Recipe<RecipeInput> {
    ...
    public static class ThrowingInSerializer implements RecipeSerializer<ThrowingInRecipe> {
        public static final MapCodec<ThrowingInRecipe> CODEC = RecordCodecBuilder.mapCodec(inst -> inst.group(
                ...
                return new ThrowingInRecipe(__list, out, ResourceLocation.fromNamespaceAndPath(ModCoreUrushi.ModID, "frying"));
        }));

        public static final StreamCodec<RegistryFriendlyByteBuf, ThrowingInRecipe> STREAM_CODEC = StreamCodec.of(
                (buf, r) -> {
                ...
                (buf) -> {
                        ...
                        return new ThrowingInRecipe(__list, __out, ResourceLocation.fromNamespaceAndPath(ModCoreUrushi.ModID, "frying"));
                }
        );

        @Override
        public MapCodec<ThrowingInRecipe> codec() { return CODEC; }

        @Override
        public StreamCodec<RegistryFriendlyByteBuf, ThrowingInRecipe> streamCodec() { return STREAM_CODEC; }
