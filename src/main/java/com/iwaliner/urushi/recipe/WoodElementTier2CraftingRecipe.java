...
public class WoodElementTier2CraftingRecipe extends AbstractElementCraftingRecipe{
    ...
    public static class WoodElementTier2CraftingSerializer implements RecipeSerializer<WoodElementTier2CraftingRecipe> {
        public static final MapCodec<WoodElementTier2CraftingRecipe> CODEC = RecordCodecBuilder.mapCodec(inst -> inst.group(
                ...
                return new WoodElementTier2CraftingRecipe(__list, out, ResourceLocation.fromNamespaceAndPath(ModCoreUrushi.ModID, "wood_element_tier2_crafting"), i);
        }));

        public static final StreamCodec<RegistryFriendlyByteBuf, WoodElementTier2CraftingRecipe> STREAM_CODEC = StreamCodec.of(
                (buf, r) -> {
                ...
                (buf) -> {
                        ...
                        return new WoodElementTier2CraftingRecipe(__list, __out, ResourceLocation.fromNamespaceAndPath(ModCoreUrushi.ModID, "wood_element_tier2_crafting"), __i);
                }
        );

        @Override
        public MapCodec<WoodElementTier2CraftingRecipe> codec() { return CODEC; }

        @Override
        public StreamCodec<RegistryFriendlyByteBuf, WoodElementTier2CraftingRecipe> streamCodec() { return STREAM_CODEC; }
