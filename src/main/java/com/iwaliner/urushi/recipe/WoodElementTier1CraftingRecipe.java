...
public class WoodElementTier1CraftingRecipe extends AbstractElementCraftingRecipe{
    ...
    public static class WoodElementTier1CraftingSerializer implements RecipeSerializer<WoodElementTier1CraftingRecipe> {
        public static final MapCodec<WoodElementTier1CraftingRecipe> CODEC = RecordCodecBuilder.mapCodec(inst -> inst.group(
                ...
                return new WoodElementTier1CraftingRecipe(__list, out, ResourceLocation.fromNamespaceAndPath(ModCoreUrushi.ModID, "wood_element_tier1_crafting"), i);
        }));

        public static final StreamCodec<RegistryFriendlyByteBuf, WoodElementTier1CraftingRecipe> STREAM_CODEC = StreamCodec.of(
                (buf, r) -> {
                ...
                (buf) -> {
                        ...
                        return new WoodElementTier1CraftingRecipe(__list, __out, ResourceLocation.fromNamespaceAndPath(ModCoreUrushi.ModID, "wood_element_tier1_crafting"), __i);
                }
        );

        @Override
        public MapCodec<WoodElementTier1CraftingRecipe> codec() { return CODEC; }

        @Override
        public StreamCodec<RegistryFriendlyByteBuf, WoodElementTier1CraftingRecipe> streamCodec() { return STREAM_CODEC; }
