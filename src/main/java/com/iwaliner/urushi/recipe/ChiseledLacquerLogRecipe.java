...
public class ChiseledLacquerLogRecipe implements Recipe<RecipeInput> {
    ...
    public static class ChiseledLacquerLogSerializer implements RecipeSerializer<ChiseledLacquerLogRecipe> {
        public static final MapCodec<ChiseledLacquerLogRecipe> CODEC = RecordCodecBuilder.mapCodec(inst -> inst.group(
                ...
                return new ChiseledLacquerLogRecipe(__list, out, ResourceLocation.fromNamespaceAndPath(ModCoreUrushi.ModID, "chiseled_lacquer_log"));
        }));

        public static final StreamCodec<RegistryFriendlyByteBuf, ChiseledLacquerLogRecipe> STREAM_CODEC = StreamCodec.of(
                (buf, r) -> {
                ...
                (buf) -> {
                        ...
                        return new ChiseledLacquerLogRecipe(__list, __out, ResourceLocation.fromNamespaceAndPath(ModCoreUrushi.ModID, "chiseled_lacquer_log"));
                }
        );

        @Override
        public MapCodec<ChiseledLacquerLogRecipe> codec() { return CODEC; }

        @Override
        public StreamCodec<RegistryFriendlyByteBuf, ChiseledLacquerLogRecipe> streamCodec() { return STREAM_CODEC; }
