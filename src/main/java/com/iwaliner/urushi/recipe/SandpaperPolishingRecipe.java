...
public class SandpaperPolishingRecipe implements Recipe<RecipeInput> {
    ...
    public static class SandpaperPolishingSerializer implements RecipeSerializer<SandpaperPolishingRecipe> {
        public static final MapCodec<SandpaperPolishingRecipe> CODEC = RecordCodecBuilder.mapCodec(inst -> inst.group(
                ...
                return new SandpaperPolishingRecipe(__list, out, ResourceLocation.fromNamespaceAndPath(ModCoreUrushi.ModID, "polishing"));
        }));

        public static final StreamCodec<RegistryFriendlyByteBuf, SandpaperPolishingRecipe> STREAM_CODEC = StreamCodec.of(
                (buf, r) -> {
                ...
                (buf) -> {
                        ...
                        return new SandpaperPolishingRecipe(__list, __out, ResourceLocation.fromNamespaceAndPath(ModCoreUrushi.ModID, "polishing"));
                }
        );

        @Override
        public MapCodec<SandpaperPolishingRecipe> codec() { return CODEC; }

        @Override
        public StreamCodec<RegistryFriendlyByteBuf, SandpaperPolishingRecipe> streamCodec() { return STREAM_CODEC; }
