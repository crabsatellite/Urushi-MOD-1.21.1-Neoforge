...
public class RecipeTypeRegister {
    public static final DeferredRegister<RecipeSerializer<?>> RECIPE_SERIALIZER =
            DeferredRegister.create(Registries.RECIPE_SERIALIZER, ModCoreUrushi.ModID);
    ...
    public static final DeferredHolder<RecipeSerializer<?>, com.iwaliner.urushi.recipe.OilExtractingRecipe.OilExtractingSerializer> OilExtractingSerializer
            = RECIPE_SERIALIZER.register("oil_extracting", com.iwaliner.urushi.recipe.OilExtractingRecipe.OilExtractingSerializer::new);

    public static final DeferredHolder<RecipeSerializer<?>, com.iwaliner.urushi.recipe.ThrowingInRecipe.ThrowingInSerializer> ThrowingInSerializer
    ...
    public static final DeferredHolder<RecipeSerializer<?>, com.iwaliner.urushi.recipe.FoxEatingRecipe.FoxEatingSerializer> FoxEatingSerializer
    ...
    public static final DeferredHolder<RecipeSerializer<?>, com.iwaliner.urushi.recipe.ChiseledLacquerLogRecipe.ChiseledLacquerLogSerializer> ChiseledLacquerLogSerializer
    ...
    public static final DeferredHolder<RecipeSerializer<?>, SilkFarmRecipe.SilkFarmSerializer> SilkwormFarmSerializer
            = RECIPE_SERIALIZER.register("silkworm", SilkFarmRecipe.SilkFarmSerializer::new);
    public static final DeferredHolder<RecipeSerializer<?>, KettleRecipe.KettleSerializer> KettleSerializer
            = RECIPE_SERIALIZER.register("kettle", com.iwaliner.urushi.recipe.KettleRecipe.KettleSerializer::new);
    public static final DeferredHolder<RecipeSerializer<?>, RainwaterTankRecipe.RainwaterTankSerializer> RainwaterTankSerializer
